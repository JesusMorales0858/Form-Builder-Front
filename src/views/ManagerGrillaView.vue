<template>
    ...
    <div v-if="!MostrarSpinner">
        ...
        <div class="row p-3">
            <div class="col">
                <router-link :to="`/modules/${idConfigForm}`" class="btn btn-outline-primary btn-sm" title="Nuevo" v-if="$store.state.permisos.includes(9)">
        ...
        <div class="table-responsive" v-if="$store.state.permisos.includes(11) & !NoHayRegistros">
                ...
                <tbody>
                    <tr v-for="Datos in dataValues">
                        ...
                        <td class="nowrap">
                            <div class="row">
                                <div class="col-auto"> 
                                    <button class="btn btn-outline-warning mx-1 btn-sm" title="Editar" @click="mostrarModalEdicion(Datos)" v-if="$store.state.permisos.includes(10)">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <div class="col-auto">
                                    <button class="btn btn-outline-danger mx-1 btn-sm" title="Eliminar"
